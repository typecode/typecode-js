...
(function(window, $) {
	...
	function InputHint(options) {
		...
		function init(me){
			...
			internal.input.$e.parent().append(internal.$e);
			
			internal.input.$e.bind('focus',{},function(e,d){
				internal.$e.fadeOut(200);
			});
			
			internal.$e.bind('click',{},function(e,d){
				internal.input.$e.trigger('focus');
			});
			
			internal.input.$e.bind('blur keyup change',{},function(e,d){
				if($(this).val().length){
					internal.$e.fadeOut(200);
				} else {
					if(e.type == 'blur'){
			...
			if(!internal.input.get_val().length){
				internal.$e.fadeIn(200);
			}
		};
