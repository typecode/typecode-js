...
define(['jquery', 'NIseed'], function($) {
    ...
    NI.co.Merlin = {
        ...
        VISIBLE_EVENT: 'merlin-visible',
        HIDDEN_EVENT: 'merlin-hidden'
    };
    ...
    var Merlin = function(options) {
        ...
        fn = {
            ...
            show_step: function(name) {
                ...
                if (internal.current_step) {
                    if (name === internal.current_step.name) {
                        if ($.isFunction(internal.current_step.visible)) {
                            fn.trigger_visible_event(internal.current_step);
                ...
                if (internal.last_step) {
                    fn.trigger_hidden_event(internal.last_step);
                }
            ...
            trigger_visible_event: function(step) {
                step.$e.find('[data-merlin-event-receiver]').trigger(NI.co.Merlin.VISIBLE_EVENT);
            },
            trigger_hidden_event: function(step) {
                step.$e.find('[data-merlin-event-receiver]').trigger(NI.co.Merlin.HIDDEN_EVENT);
            },
