...
(function(window, $) {
	...
	function Merlin(options) {
		...
		function show_step(step){
			...
			if(internal.current_step.inputs){
				for(i in internal.current_step.inputs){
					internal.current_step.inputs[i].component.get_dom().trigger('change');
				}
			}
		...
		control_handlers = {
			next:function(e,d){
				...
				console.log(e);
				console.log(internal.current_step);
