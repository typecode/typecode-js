...
define([
	'jquery',
	'lib/typecode-js/lib/field/tc.field.validator',
	'lib/typecode-js/lib/field/tc.field.std',
	'lib/typecode-js/lib/field/tc.field.hint',
	'lib/typecode-js/lib/field/tc.field.simple_tooltip',
	'lib/typecode-js/lib/field/tc.field.hint'
], function($) {
		...
		function show_step(step, nav_data){
			...
			if (o.transition=='fade') {
				if (internal.counters.n_times_step_rendered !== 0) {
					o.$e.find(internal.current_step.selector).fadeIn(o.transition_speed);
					o.$e.find(internal.last_step.selector).fadeOut(o.transition_speed);
				} else {
