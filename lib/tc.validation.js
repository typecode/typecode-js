...
//The purpose of following if statement is first checking to see if the field is an instance of
//NI.field and to fetch the value that needs to be validated.
